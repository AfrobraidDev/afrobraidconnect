  ...
  const options = [
    {
      ...
      href: "/signup?user_type=customer",
      icon: <ArrowRight className="h-5 w-5 text-purple-600" />
    },
    {
      title: "Afro-connect for customers",
      subtitle: "Login to book salons and spas near you",
      href: "/login?user_type=customer",
      icon: <ArrowRight className="h-5 w-5 text-purple-600" />
    },
    {
      title: "Afro-connect for professionals",
      subtitle: "Sign up to manage and grow your business",
      href: "/signup?user_type=professional",
      icon: <ArrowRight className="h-5 w-5 text-purple-600" />
    },
    {
      title: "Afro-connect for professionals",
      subtitle: "Login to manage and grow your business",
      href: "/login?user_type=professional",
      icon: <ArrowRight className="h-5 w-5 text-purple-600" />
    }
  ];
